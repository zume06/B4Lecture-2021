...
def main():
    ...
    # regression
    x_reg_3, y_reg_3, w_3 = reg_2d(x, y, args.reg_x_d, 0.1)
    x_reg_9, y_reg_9, w_9 = reg_2d(x, y, 9, 0.1)
    # get regression label
    reg_label_3 = get_label_2d(w_3)
    reg_label_9 = get_label_2d(w_9)
    ...
    ax.plot(x_reg_3, y_reg_3, color='orange', label='l=0.1 ' + reg_label_3)
    # ax.plot(x_reg_5, y_reg_5, color='orange', label='l=0.5 ' + reg_label_5)
    ax.plot(x_reg_9, y_reg_9, color='red', label='l=0.1 ' + reg_label_9)
